...
class Action
{
    ...
    public function toArray(): array
    {
        ...
        if ($this->type === 'close') {
            return [
                ...
                'class' => $this->resolveClass($this->class, $paletteName, $outline),
    ...
    private function resolveClass(string $class, ?string $paletteName, bool $outline): string
    {
        $paletteClass = $this->resolvePaletteClasses($paletteName, $outline);
    ...
    private function resolvePaletteClasses(?string $paletteName, bool $outline): string
    {
